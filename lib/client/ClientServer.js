...
const ClientStats = __importDefault(require("../models/ClientStats"));
...
class ClientServer extends ClientServer_1.default {
    ...
    stats() {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let res = yield this.api.call(`/client/servers/${this.identifier}/resources`);
                resolve(new ClientStats(res.data.attributes.resources));
            }
            catch (error) {
                reject(error);
            }
    ...
    cpuUsage() {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let res = yield this.api.call(`/client/servers/${this.identifier}/resources`);
                resolve(res.data.attributes.resources.cpu);
            }
            catch (error) {
                reject(error);
            }
    ...
    diskUsage() {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let res = yield this.api.call(`/client/servers/${this.identifier}/resources`);
                resolve(res.data.attributes.resources.disk);
            }
            catch (error) {
                reject(error);
            }
    ...
    memoryUsage() {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let res = yield this.api.call(`/client/servers/${this.identifier}/resources`);
                resolve(res.data.attributes.resources.memory);
            }
            catch (error) {
                reject(error);
            }
