...
class Server extends Server_1.default {
    ...
    static getByUuid(api, uuid) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                resolve(server ? new Server(api, server.attributes) : null);
            }
            catch (error) {
                reject(error);
            }
    ...
    static getByUserId(api, user) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                resolve(servers.map((server) => new Server(api, server.attributes)));
            }
            catch (error) {
                reject(error);
            }
    ...
    writeFile(file, text) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                let write = yield this.api.call(`/application/servers/${this.id}/files/write?file=${file}`, 'POST', text, true);
                resolve(write);
            }
            catch (error) {
                reject(error);
